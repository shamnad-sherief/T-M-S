			...
			<div class="col-lg-12">
				<div class="dashboard-list-box margin-top-0">
					...
					<tbody>
						...
						<td><a href="sff_edit_veh.php?veh_id=<?php echo urlencode($veh_id);?>&fac=<?php echo urlencode($fa);?>" class="fa fa-edit" title="edit"></a>     <a href="code_delete_veh.php?veh_id=<?php echo urlencode($veh_id);?>&fac=<?php echo urlencode($fa);?>" class="fa fa-trash-o" title="delete"></a></td>
						</tr>
					<?php }?>
						</tbody>
						</table>
