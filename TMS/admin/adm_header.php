	...
	<div id="header" class="not-sticky">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="adm_home.php?fac=<?php echo urlencode($fa);?>"><img src="../img/logo.png" alt=""></a>
					<a href="adm_home.php?fac=<?php echo urlencode($fa);?>" class="dashboard-logo"><img src="../img/logo.png" alt=""></a>
				</div>
