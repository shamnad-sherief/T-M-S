...
$sel3=mysqli_query($con,"select count(staff_id) as tot_staff from tbl_staff where status='nostatus'");
 ...
 ?>
			...
			<div class="col-lg-3 col-md-6">
				<div class="dashboard-stat color-1">
					<div class="dashboard-stat-content"><h4><?php echo $tot1['tot_pro']; ?></h4> <span>Total Packages</span></div>
			...
			<div class="col-lg-3 col-md-6">
				<div class="dashboard-stat color-3">
					<div class="dashboard-stat-content"><h4><?php echo $tot3['tot_staff']; ?></h4> <span>Total Staff</span></div>
			...
			<div class="col-lg-3 col-md-6">
				<div class="dashboard-stat color-4">
					<div class="dashboard-stat-content"><h4><?php echo $tot4['tot_book']; ?></h4> <span>Total Booking</span></div>
