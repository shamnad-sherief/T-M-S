			...
			<div class="row">
				<div class="col-md-12">
					...
					<nav id="breadcrumbs">
						<ul>
							<li><a href="#">Home</a></li>
							<li>View Accomdation details</li>
						</ul>
					</nav>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="dashboard-list-box margin-top-0">
					<h4>All the Accomdation details</h4>
					...
					<tbody>
						...
						<td><a href="adm_edit_acco.php?acco_id=<?php echo urlencode($acco_id);?>&fac=<?php echo urlencode($fa);?>" class="fa fa-edit" title="edit"></a>     <a href="code_delete_acco.php?acco_id=<?php echo urlencode($acco_id);?>&fac=<?php echo urlencode($fa);?>" class="fa fa-trash-o" title="delete"></a></td>
						</tr>
					<?php }?>
						</tbody>
						</table>
